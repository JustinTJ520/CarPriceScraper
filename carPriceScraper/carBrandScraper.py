...
def scrape_page(soup, brands):
    ...
    brandElements = soup.select('div.a-z dd a')
...
base_url = 'https://www.carlogos.org/car-brands-a-z/'
...
with open('carBrands.csv', 'w', encoding='utf-8', newline='') as csv_file:
...
print("Scraping complete. Brands saved to 'carBrands.csv'.")
